...
@Mapper
@Component(value = "mpatDispatchDao")
public interface MpatDispatchDao{
	/**
    ...
    int insertOrUpdate(List<MpatDispatch> list);

    int selectMpatDispatchCountByCaseId(String caseId);

    List<MpatDispatch> selectMpatDispatchByCaseId(String caseId);

	List<MpatDispatch> selectMpatDispatchIsExist(MpatDispatch enti);

	int updateNonEmptyMpatDispatchByCaseAndStaff(MpatDispatch enti);
